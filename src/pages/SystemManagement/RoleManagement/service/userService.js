...
export async function addUserRole(params) {
  return UAAService.request(`/proxy/ali/b2b/user/v1/role/addUserRole`, {
    body: params,
    method: 'POST',
  });
}
...
export async function modifyUserRole(params) {
  return UAAService.request(`/proxy/ali/b2b/user/v1/role/modifyUserRole`, {
    body: params,
    method: 'POST',
  });
}
...
export async function queryMenuTree(params) {
  return UAAService.request(`/proxy/ali/b2b/user/v1/menu/queryMenuTree`, {
    params,
    method: 'GET',
  });
}
