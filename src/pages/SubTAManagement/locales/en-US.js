export default {
  MENU_SUB_TA_MANAGEMENT: 'Sub-Travel Agent Management',
  MENU_SUB_TA_PROFILE: 'Sub-Travel Agent Profile',
  MENU_SUB_TA_MAIN_MANAGEMENT: 'Sub-Travel Agent Management',
  ...
  SUB_TA_MAIN_TA_NAME: 'Main Travel Agent Name',
  SUB_TA_FULL_NAME: 'Full Name',
  SUB_TA_EMAIL: 'Email',
  SUB_TA_COMPANY_NAME: 'Company Name',
  SUB_TA_COUNTRY_INCORPORATION: 'Sub-Travel Agent Country of Incorporation',
  ...
  SUB_TA_TABLE_ENABLE: 'Activation',
  SUB_TA_TABLE_PROHIBIT: 'Deactivation',
  SUB_TA_M_TABLE_STATUS_ACTIVE: 'ACTIVE',
  SUB_TA_M_TABLE_STATUS_INACTIVE: 'INACTIVE',

  SUB_TA_HIS_TABLE_Q_START_TIME: 'Start Date',
  SUB_TA_HIS_TABLE_Q_END_TIME: 'End Date',
  SUB_TA_HIS_TABLE_NO: 'No.',
  SUB_TA_HIS_TABLE_CONTACT_UPLOADED_BY: 'Update By',
  SUB_TA_HIS_TABLE_CONTACT_UPLOADED_TIME: 'Update Date',
  SUB_TA_HIS_TABLE_STATE_STATUS_BEFORE: 'Status Before',
  SUB_TA_HIS_TABLE_STATE_STATUS_AFTER: 'Status After',
  SUB_TA_STATE_CHANGE_HISTORY: 'STATUS CHANGE HISTORY',
  SUB_TA_BTN_MODIFY: 'Modify',
  PROHIBIT_SUB_TA_PROFILE_SUCCESS: 'Deactivate Sub-Travel Agent profile successfully.',
